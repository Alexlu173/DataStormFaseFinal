...
<template>
  <footer class="bg-base-300 text-gray-700 py-8 mt-10">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 px-4">
      <div class="flex items-center gap-2">
        ...
        <span class="font-bold text-lg">DataStorm</span>
      </div>
      <nav class="flex gap-6">
        <a href="#" class="hover:underline">Contacto</a>
        <a href="#" class="hover:underline">Política de privacidad</a>
        <a href="https://github.com/" target="_blank" class="hover:underline flex items-center gap-1">
      ...
      <div class="text-sm text-gray-500">&copy; 2025 DataStorm. Todos los derechos reservados.</div>
    </div>
  </footer>
</template>
